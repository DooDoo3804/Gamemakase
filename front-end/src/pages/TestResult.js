...
const results = {
  ...
  6: {
    name: "캐주얼 게임 애호가",
    description:
      '"상식은 언제나 삶의 이정표지만, 때론 그 이정표를 벗어나야만 보이는 것도 있다." - 《Portal》\n\n당신은 캐주얼 게임 애호가(Casual Gamer)입니다!\n캐주얼 게임 애호가는 일상적이고 무난한 게임을 즐기는 사람들입니다. 게임을 즐길 때에는 경쟁보다는 즐길거리를 중요시하며, 스트레스를 푸는 용도로 즐기는 경우가 많습니다. 간단하면서도 중독성이 높은 게임으로, 다른 유저들과 함께 진행하는 재미가 있습니다. 게임은 열정과 재미를 제공하는 것 외에도, 더 많은 것을 배울 수 있는 유익한 측면도 가지고 있습니다. 게임을 즐기면서 새로운 것을 배우고, 자신만의 재미있는 경험을 만들어보세요!',
    ...
    <TestWrapper>
      ...
      >
        ...
        <div className="result-btns-wrapper">
          ...
          <div className="single-btn">
            <SharingModal
              route={"https://gamemakase.com/testresult/" + resultId}
              title={results[resultId].name}
              description="지금 Gamemakase에서 게임 성향을 테스트 해보세요."
            ></SharingModal>
          </div>
        </div>
      </motion.div>
